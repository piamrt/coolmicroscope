classdef Fast_Tiff _Write  < handle
    % FAST_TIFF _WRITE Aims to write tiff data quickly on the fly
    ...
    methods
        function obj = Fast_Tiff _Write(filename,pixelsize,compression)
